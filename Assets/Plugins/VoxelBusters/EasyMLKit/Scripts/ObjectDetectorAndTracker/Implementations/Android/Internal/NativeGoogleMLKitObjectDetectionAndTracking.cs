...
namespace VoxelBusters.EasyMLKit.Implementations.Android.Internal
{
    public class NativeGoogleMLKitObjectDetectionAndTracking : NativeAndroidJavaObjectWrapper
    {
       ...
       public NativeGoogleMLKitObjectDetectionAndTracking(NativeContext context, NativeAbstractInputImageProducer inputImageProducer) : base(Native.kClassName ,(object)context.NativeObject, (object)inputImageProducer.NativeObject)
       {
       }
        ...
        public void Prepare(NativeObjectDetectionAndTrackingOptions options)
        {
#if NATIVE_PLUGINS_DEBUG_ENABLED
            DebugLogger.Log("[Class : NativeGoogleMLKitObjectDetectionAndTracking][Method : Prepare]");
#endif
            Call(Native.Method.kPrepare, new object[] { options.NativeObject } );
        }
        public void Process()
        {
#if NATIVE_PLUGINS_DEBUG_ENABLED
