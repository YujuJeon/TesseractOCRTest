...
namespace VoxelBusters.EasyMLKit.Implementations.Android.Internal
{
    public class NativeGoogleMLKitBarcodeScanner : NativeAndroidJavaObjectWrapper
    {
       ...
       public NativeGoogleMLKitBarcodeScanner(NativeContext context, NativeAbstractInputImageProducer inputImageProducer) : base(Native.kClassName ,(object)context.NativeObject, (object)inputImageProducer.NativeObject)
       {
       }
