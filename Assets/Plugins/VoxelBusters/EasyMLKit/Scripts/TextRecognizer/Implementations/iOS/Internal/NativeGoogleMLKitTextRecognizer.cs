...
namespace VoxelBusters.EasyMLKit.Implementations.iOS.Internal
{
    internal class NativeGoogleMLKitTextRecognizer
    {
        ...
        public static extern IntPtr MLKit_TextRecognizer_InitWithInputSource(IntPtr inputSourcePtr);
        ...
        [DllImport("__Internal")]
        public static extern void MLKit_TextRecognizer_Prepare(IntPtr TextRecognizerPtr, IntPtr barcodeScanOptionsPtr);
        ...
        public NativeGoogleMLKitTextRecognizer(IntPtr inputSource)
        {
            m_nativeHandle = MLKit_TextRecognizer_InitWithInputSource(inputSource);
        }
        ...
        public void Prepare(NativeTextRecognizerScanOptions options)
        {
            MLKit_TextRecognizer_Prepare(m_nativeHandle, options.NativeHandle);
        }
        public void Process()
        {
