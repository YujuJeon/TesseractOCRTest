...
{
    public class NativeFeatureBase
    {
        protected IInputSource m_inputSource;

        private NativeSlice<sbyte> m_nativeSlice;
        private sbyte[] m_nativeSbytes;
        private Texture2D m_texture2d;

        protected NativeFeatureBase(IInputSource inputSource)
        {
            m_inputSource = inputSource;
        }

        protected NativeAbstractInputImageProducer GetNativeInputImageProducer(IInputSource inputSource)
        {
